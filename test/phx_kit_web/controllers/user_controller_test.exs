defmodule PhxKitWeb.UserControllerTest do
  use PhxKitWeb.ConnCase

  import PhxKit.AdminsFixtures

  @create_attrs %{confirmed_at: ~N[2023-02-12 23:50:00], email: "some email", hashed_password: "some hashed_password", name: "some name"}
