defmodule PhxKitWeb.UserSettingsLive do
  use PhxKitWeb, :live_view_profile
      ...
      <div class="shadow sm:rounded-md sm:overflow-hidden">
        <div class="bg-white py-6 px-4 sm:p-6">
          <.header>
            Change Email
            <:subtitle>
              You need confirm your email password to change your email
            </:subtitle>
          </.header>
      ...
      <div class="shadow sm:rounded-md sm:overflow-hidden">
        <div class="bg-white py-6 px-4 sm:p-6">
          <.header>
            Change Password
            <:subtitle>
              Please make sure you have remember or copied new password to anything else
            </:subtitle>
          </.header>
